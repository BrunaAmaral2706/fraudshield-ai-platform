...
import { STATUS_OPTIONS, RISK_LEVEL_STYLES, AI_SEVERITY_STYLES, formatProbability } from '../utils/formatters';
              ...
              {[
                ...
                ...(showAiColumns
                  ? [
                      ...
                      { key: 'anomaly_score', label: 'Anomaly', sortable: false },
                      { key: 'ai_confidence', label: 'AI Conf.', sortable: false },
                        ...
                        <>
                          ...
                          <td className="px-5 py-3.5">
                            <span className="font-mono text-[12px] text-amber-600">
                              {tx.anomaly_score != null ? Number(tx.anomaly_score).toFixed(2) : '—'}
                            </span>
                          </td>
                          <td className="px-5 py-3.5">
                            <span className="font-mono text-[12px] text-emerald-600">
                              {tx.ai_confidence != null ? `${tx.ai_confidence}%` : '—'}
                            </span>
                          </td>
                          <td className="px-5 py-3.5">
                            {tx.severity && (
                              <span
                                ...
                                title={tx.ai_explanation ?? tx.risk_explanation?.summary}
                              >
                                {tx.severity}
                              </span>
                            )}
