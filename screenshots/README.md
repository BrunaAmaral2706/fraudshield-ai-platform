...
Adicione aqui as capturas de tela do FraudShield para exibição no README do GitHub.

| Arquivo | Página | Resolução sugerida |
|---------|--------|--------------------|
...
**Como capturar:** com backend e frontend rodando, acesse cada rota em `http://localhost:5173` e exporte PNG (Windows: `Win + Shift + S`).
